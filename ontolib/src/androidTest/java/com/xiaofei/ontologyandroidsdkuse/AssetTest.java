...
//        System.out.println("********" + ontSdk.nativevm().ong().queryAllowance(account1.getAddressU160().toBase58(),acct1.getAddressU160().toBase58()));
    ...
    public void wasm(){
        ...
        assertEquals("69d4d73f8fa51795a890bbd401c5a19ed248d4b3260474657374012fb04a9a3b02d1081de542e922bf0256969f15123b9fb3658d1fd752c722bf2a",Helper.toHexString(bs));
    }
}