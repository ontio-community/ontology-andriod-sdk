...
public class Oep4 {
    ...
    private Object sendInit(Account acct, Account payerAcct,long gaslimit,long gasprice,boolean preExec) throws Exception {
        ...
        if(preExec) {
            ...
            if (Integer.parseInt(((JSONObject) obj).getString("State")) != 1){
    ...
    public Transaction makeTransferMulti(State[] states,Account payerAcct,long gaslimit, long gasprice) throws Exception {
