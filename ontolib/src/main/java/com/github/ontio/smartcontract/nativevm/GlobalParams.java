...
public class GlobalParams {
    ...
    public Transaction makeTransferAdmin(Address newAdminAddr,String payerAddr, long gaslimit,long gasprice) throws Exception {
    ...
    public Transaction makeAcceptAdmin(Address multiAddr,String payerAddr, long gaslimit,long gasprice) throws Exception {
    ...
    public String getGlobalParam(String[] paramNameList) throws Exception {
    ...
    public Transaction makeSetGlobalParam(Params params,String payerAddr,long gaslimit,long gasprice) throws Exception {
    ...
    public Transaction makeSetOperator(Address addr,String payerAddr,long gaslimit,long gasprice) throws Exception {
    ...
    public Transaction makeCreateSnapshot(String payerAddr,long gaslimit,long gasprice) throws Exception {
