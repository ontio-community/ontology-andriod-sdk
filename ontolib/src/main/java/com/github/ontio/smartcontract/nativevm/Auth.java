...
public class Auth {
    ...
    public String sendInit(String adminOntId,String password,byte[] salt, String contractAddr,Account payerAcct,long gaslimit,long gasprice) throws Exception {
     ...
     * @throws Exception
     */
    public String sendTransfer(String adminOntId, String password,byte[] salt,long keyNo,  String contractAddr, String newAdminOntID, Account payerAcct, long gaslimit, long gasprice) throws Exception {
     ...
     * @throws SDKException
     */
    public Transaction makeTransfer(String adminOntID,String contractAddr, String newAdminOntID,long keyNo,String payer,long gaslimit,long gasprice) throws Exception {
     ...
     * @throws SDKException
     */
    public Transaction makeVerifyToken(String ontid,String contractAddr,String funcName,long keyNo) throws Exception {
     ...
     * @throws Exception
     */
    public String assignFuncsToRole(String adminOntID,String password,byte[] salt, long keyNo,String contractAddr,String role,String[] funcName,Account payerAcct,long gaslimit,long gasprice) throws Exception {
     ...
     * @throws SDKException
     */
    public Transaction makeAssignFuncsToRole(String adminOntID,String contractAddr,String role,String[] funcName,long keyNo,String payer,long gaslimit,long gasprice) throws Exception {
     ...
     * @throws Exception
     */
    public String assignOntIdsToRole(String adminOntId,String password,byte[] salt,long keyNo, String contractAddr,String role,String[] ontIDs,Account payerAcct,long gaslimit,long gasprice) throws Exception {
     ...
     * @throws SDKException
     */
    public Transaction makeAssignOntIDsToRole(String adminOntId,String contractAddr,String role,String[] ontIDs,long keyNo,String payer,long gaslimit,long gasprice) throws Exception {
     ...
     * @throws Exception
     */
    public String delegate(String ontid,String password,byte[] salt, long keyNo,String contractAddr,String toOntId,String role,long period,long level,Account payerAcct,long gaslimit,long gasprice) throws Exception {
     ...
     * @throws SDKException
     */
    public Transaction makeDelegate(String ontid,String contractAddr,String toAddr,String role,long period,long level,long keyNo,String payer,long gaslimit,long gasprice) throws Exception {
     ...
     * @throws Exception
     */
    public String withdraw(String initiatorOntid,String password,byte[] salt,long keyNo, String contractAddr,String delegate, String role,Account payerAcct,long gaslimit,long gasprice) throws Exception {
     ...
     * @throws SDKException
     */
    public Transaction makeWithDraw(String ontid,String contractAddr,String delegate, String role,long keyNo,String payer,long gaslimit,long gasprice) throws Exception {
...
class VerifyTokenParam extends Serializable{
    byte[] contractAddr;
    byte[] caller;
    byte[] fn;
    long keyNo;
...
class FuncsToRoleParam extends Serializable{
    byte[] contractAddr;
    byte[] adminOntID;
    byte[] role;
    String[] funcNames;
...
class DelegateParam extends  Serializable{
    byte[] contractAddr;
    byte[] from;
    byte[] to;
    byte[] role;
