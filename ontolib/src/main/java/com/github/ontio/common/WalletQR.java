...
public class WalletQR {
    ...
    public static String getPriKeyFromQrCode(String qrcode,String password) throws SDKException {
        ...
        try {
            return com.github.ontio.account.Account.getGcmDecodedPrivateKey(key,password,address, Base64.decode(salt,Base64.NO_WRAP),n, SignatureScheme.SHA256WITHECDSA);
        } catch (Exception e) {
            e.printStackTrace();
