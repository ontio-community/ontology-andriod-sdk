...
//            showEvent(ontSdk, "sendRegister", txhash);
            ...
            JSONObject payload = JSONObject.parseObject(new String(Base64.decode(claims[1].getBytes(),Base64.NO_WRAP)));
            ...
            Account account = ontSdk.getWalletMgr().importAccount(
                    ...
                    Base64.decode("0hAaO6CT+peDil9s5eoHyw==",Base64.NO_WRAP));
...
//        String ip = "http://101.132.193.149";
    ...
    public static void showEvent(OntSdk ontSdk, String methodName, String txHash) throws Exception {
