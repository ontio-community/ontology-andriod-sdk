...
public class SmokeExceptionTest {
    ...
    public void sendTransferError() throws Exception {
        ...
        try {
            ontAssetTx.sendTransfer("aaa",richAddr,"123123",poorAddr,1,0);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("58012"));
        }

        try {
            ontAssetTx.sendTransfer("ont",richAddr,"123123",poorAddr,0,0);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("58016"));
        }

        try {
            ontAssetTx.sendTransfer("ont",richAddr,"123123",poorAddr,-1,0);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("58016"));
        }

        try {
            ontAssetTx.sendTransfer("ont","","123123",poorAddr,1,0);
        } catch (Exception e) {
            assertTrue(e.getMessage().contains("58004"));
        }
        ;
        try {
            ontAssetTx.sendTransfer("ont",richAddr,"123123","",1,0);
        } catch (Exception e) {
            assertTrue(e.getMessage().contains("58004"));
        }
    ...
    public void sendTransferManyError() throws Exception {
        ...
        try {
            ontAssetTx.sendTransferFromMany("aaa",new String[]{richAddr,poorAddr1},new String[]{"123123","123123"},poorAddr2,new long[]{amount1,amount2},0);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("58012"));
        }

        try {
            ontAssetTx.sendTransferFromMany("ont",new String[]{richAddr,poorAddr1},new String[]{"123123","123123"},poorAddr2,new long[]{0,amount2},0);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("58016"));
        }

        try {
            ontAssetTx.sendTransferFromMany("ont",new String[]{richAddr,poorAddr1},new String[]{"123123","123123"},poorAddr2,new long[]{amount1,-1},0);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("58016"));
        }

        try {
            ontAssetTx.sendTransferFromMany("ont",new String[]{"",poorAddr1},new String[]{"123123","123123"},poorAddr2,new long[]{amount1,amount2},0);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("58004"));
        }

        try {
            ontAssetTx.sendTransferFromMany("ont",new String[]{richAddr,""},new String[]{"123123","123123"},poorAddr2,new long[]{amount1,amount2},0);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("58004"));
        }

        try {
            ontAssetTx.sendTransferFromMany("ont",new String[]{richAddr,poorAddr1},new String[]{"123123","123123"},"",new long[]{amount1,amount2},0);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("58004"));
        }

        try {
            ontAssetTx.sendTransferFromMany("ont",new String[]{richAddr,poorAddr1},new String[]{"","123123"},poorAddr2,new long[]{amount1,amount2},0);
        }catch (Exception ex){
        ...
        try {
            ontAssetTx.sendTransferToMany("aaa",poorAddr2,"123123",new String[]{richAddr,poorAddr1},new long[]{amount1,amount2},0);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("58012"));
        }

        try {
            ontAssetTx.sendTransferToMany("ont",poorAddr2,"123123",new String[]{richAddr,poorAddr1},new long[]{0,amount2},0);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("58105"));
        }

        try {
            ontAssetTx.sendTransferToMany("ont",poorAddr2,"123123",new String[]{richAddr,poorAddr1},new long[]{amount1,-1},0);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("58105"));
        }

        try {
            ontAssetTx.sendTransferToMany("ont","","123123",new String[]{richAddr,poorAddr1},new long[]{amount1,amount2},0);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("58004"));
        }

        try {
            ontAssetTx.sendTransferToMany("ont",poorAddr2,"123123",new String[]{"",poorAddr1},new long[]{amount1,amount2},0);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("58004"));
        }

        try {
            ontAssetTx.sendTransferToMany("ont",poorAddr2,"123123",new String[]{richAddr,""},new long[]{amount1,amount2},0);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("58004"));
        }

        try {
            ontAssetTx.sendTransferToMany("ont",poorAddr2,"",new String[]{richAddr,poorAddr1},new long[]{amount1,amount2},0);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("51015"));
        }

        try {
            ontAssetTx.sendTransferToMany("ont",poorAddr2,"123123",new String[]{richAddr,poorAddr1},new long[]{amount1,amount2},-1);
        }catch (Exception ex){
            assertTrue(ex.getMessage().contains("51015"));
        }
    }
    ...
    public void sendOngError() throws Exception {
        ...
        String message="";
        try {
            ontAssetTx.sendOngTransferFrom(richAddr,"123123",richAddr,0,0);
        }catch (Exception ex){
        ...
        try {
            ontAssetTx.sendOngTransferFrom(richAddr,"123123",richAddr,-1,0);
        }catch (Exception ex){
            message = ex.getMessage();
        }finally {
            assertTrue(message.contains("58016"));
        ...
        try {
            ontAssetTx.sendOngTransferFrom("","123123",richAddr,amount,0);
        }catch (Exception ex){
            message = ex.getMessage();
        }finally {
        ...
        try {
            ontAssetTx.sendOngTransferFrom(richAddr,"123123","",amount,0);
        }catch (Exception ex){
            message = ex.getMessage();
        }finally {
            assertTrue(message.contains("58004"));
        ...
        try {
            ontAssetTx.sendOngTransferFrom(richAddr,"",richAddr,amount,0);
        }catch (Exception ex){
            message = ex.getMessage();
        }finally {
